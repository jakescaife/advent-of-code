...
fn solve_puzzle(input: &str) -> usize {
    let mut initial_state = State::initial_state(input);
    initial_state.floors[0].insert(Object::Microchip("elerium".to_string()));
    initial_state.floors[0].insert(Object::Generator("elerium".to_string()));
    initial_state.floors[0].insert(Object::Microchip("dilithium".to_string()));
    initial_state.floors[0].insert(Object::Generator("dilithium".to_string()));
