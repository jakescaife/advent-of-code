...
fn main() {
    ...
    println!("AOC 2016-17 Part One: {}", solve_puzzle(&input));
}
...
fn breadth_first_search(password: &str) -> String {
...
mod tests {
    ...
    fn example_solutions() {
        assert_eq!("DDRRRD", &solve_puzzle("ihgpwlah"));
        assert_eq!("DDUDRLRRUDRD", &solve_puzzle("kglvqrro"));
        assert_eq!("DRURDRUDDLLDLUURRDULRLDUUDDDRR", &solve_puzzle("ulqzkmiv"));
    }
}
