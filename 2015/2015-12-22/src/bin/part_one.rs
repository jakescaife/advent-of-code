fn main() {
    ...
    println!("AOC 2015-22 Part One: {}", puzzle_solution);
}
...
mod tests {
    ...
    fn example_solutions() {
        let fighter = Fighter::new(10, 250);
        let boss = Boss {
            health: 13,
            damage: 8,
        };

        assert_eq!(226, minimum_mana_spend(fighter, boss, i32::MAX));
    }
    ...
    fn harder_boss() {
        ...
        assert_eq!(641, minimum_mana_spend(fighter, boss, i32::MAX));
    }
}
